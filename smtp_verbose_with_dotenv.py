# smtp_verbose_with_dotenv.py
import os, smtplib, ssl
from email.message import EmailMessage

# attempt to load .env from current working dir using python-dotenv
try:
    from dotenv import load_dotenv
    load_dotenv()
    print("Loaded .env (if present) using python-dotenv.")
...
# Try STARTTLS (587) and implicit SSL (465)
